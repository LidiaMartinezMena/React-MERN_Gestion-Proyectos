...
const ModalFormularioTarea = () => {
    ...
    useEffect(() => {
        //Si tiene un ID guardado es que estamos editando una tarea:
       if(tarea?._id){
        setId(tarea._id)
...
//Agregar la tarea o cambios en la base de datos:
                                ...
                                <div className="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left w-full">
                                    ...
                                    {msg && <Alerta alerta={alerta} /> }
                                        <form 
                                            ...
                                            <input 
                                                type= 'submit'
                                                className=' text-center bg-sky-600 hover:bg-sky-700 w-full p-3 text-white uppercase font-bold cursor-pointer transition-colors rounded'
